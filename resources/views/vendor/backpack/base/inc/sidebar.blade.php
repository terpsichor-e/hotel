    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ backpack_url('feature') }}"><i class="fa fa-tag"></i> <span>Удобства</span></a>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-tag"></i> <span>Номерной фонд</span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="{{ backpack_url('room/class') }}"><i
                                        class="fa fa-user"></i> <span>Классы</span></a></li>
                        <li><a href="{{ backpack_url('room') }}"><i
                                        class="fa fa-group"></i> <span>Номера</span></a></li>
                    </ul>
                </li>
                <li class="treeview">
